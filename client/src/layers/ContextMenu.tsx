...
export default function ContextMenu({ map, route, queryPoints }: Readonly<ContextMenuProps>) {
        ...
        <div class="details-popup-container">
            ...
            <div class="details-popup-content">
                ...
                <div class="details-row">
                    ...
                    <a href="${data.webSite || '#'}" class="details-value" target="_blank" style="color: #2c8ff4;">${
            data.webSite || 'N/A'
        }</a>
                </div>
                <div class="details-row">
    ...
    function formatAboutSection(aboutData: any): string {
        return aboutData
            .map((section: any) => {
                ...
                const details = section[2].map((detail: any) => detail[1]).join(', ')
